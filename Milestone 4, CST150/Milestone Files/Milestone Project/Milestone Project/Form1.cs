...
namespace Milestone_Project
{
    public partial class Form1 : Form
    {
        ...
        private void searchInventoryButton_Click(object sender, EventArgs e)
        {
            ...
            if (temp.searchArrayName(inventoryList, selection) != -1)
            {
                ...
                if (decimal.TryParse(searchProductPriceBox.Text, out selectionPrice))
                {
                    ...
                    {
                        int priceIndex = temp.searchArrayPrice(inventoryList, selectionPrice);
        ...
        private void orderMoreButton_Click(object sender, EventArgs e)
        {
            ...
            if (temp.searchArrayName(inventoryList, selection) != -1)
            {
                int index = temp.searchArrayName(inventoryList, selection);
    ...
    public class InventoryManager
    {
        ...
        public int searchArrayName(List<InventoryItems> inventoryList, string value)
        {
        ...
        public int searchArrayPrice(List<InventoryItems> inventoryList, decimal value)
        {
